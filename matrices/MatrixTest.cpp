...
{
    Matrix<int> matrix("../matrices/text/MatrixInteger.txt", 10, 3);
    testing::internal::CaptureStdout();
    std::cout << matrix;
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "{Matrix:\n"
...
{
    Matrix<int> matrix("../matrices/text/MatrixTestInteger", 4, 3);
    testing::internal::CaptureStdout();
    std::cout << matrix.transpose();
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "{Matrix:\n"
...
{
    Matrix<bool> matrix("../matrices/text/inverse2.txt", 3, 3);
    testing::internal::CaptureStdout();
    std::cout << matrix.inverse();
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "{Matrix:\n"
...
{
    Matrix<int> matrix("../matrices/text/array.txt", 3, 3);
    EXPECT_THROW(matrix.inverse(), MatrixException);
}
...
{
    Matrix<int> matrix("../matrices/text/array.txt", 3, 3);
    Matrix<int> matrix1("../matrices/text/MatrixTestInteger", 3, 4);
...
{
    Matrix<float> matrix("../matrices/text/MatrixTestInteger", 4, 3);
    testing::internal::CaptureStdout();
...
{
    Matrix<int> matrix("../matrices/text/MatrixTestInteger", 4, 3);
    Matrix<int> matrix1("../matrices/text/multiplyVector1.txt", 1, 4);
    testing::internal::CaptureStdout();
...
{
    Matrix<double> matrix("../matrices/text/multiply", 5, 3);
    Matrix<double> matrix1("../matrices/text/multiplyVector2.txt", 1, 5);
    testing::internal::CaptureStdout();
    std::cout << matrix * matrix1;
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "{Matrix:\n"
